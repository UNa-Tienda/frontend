<template>
  ...
  >
    <div>
      ...
      >
        <b-carousel-slide caption="Primer Slide" text="Carrusel primera imagen">
          <template v-slot:img>
            <img
              ...
              src="../assets/food.jpg"
              alt="image slot"
              style="height: 30vw; max-height: 480px"
            />
          </template>
        </b-carousel-slide>
        ...
        <b-carousel-slide caption="Tercer Slide" text="Carrusel tercera imagen">
          <template v-slot:img>
            <img
              class="d-block img-fluid w-100"
              width="1024"
