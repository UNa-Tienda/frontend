    ...
    <div>
        ...
        <div class="container-fluid containerExternoPost">
          <div class="infoPost">
            ...
            >
                <b-row >
                  <h1 class="col-12 text-center text-primary mt-5 mb-5">Publicar Producto</h1>
                </b-row>
                <b-row class="mt-5">
                  ...
                  <b-col cols=" xs-12 sm-12 auto" md="6" >
                    ...
                    <b-row>
                      ...
                      <b-col cols="xs-12 sm-12 auto" md="6" >
                        <b-form-spinbutton  class="col-12" id="stock" v-model="stock" min="1" max="100"></b-form-spinbutton>
                      </b-col>
                    </b-row>
                    <br />
                    <b-form-group
                ...
                <div class="text-center" align-v="center">
                  <b-button class ="col-12 mt-2" size="lg" type="sumbit" variant="primary"
                  >Publicar post
                  </b-button>
                </div>
            </b-form>
